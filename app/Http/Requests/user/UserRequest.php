...
class UserRequest extends FormRequest
{
    ...
    protected $rules = [
        ...
        'number_id' => ['required', 'numeric', 'unique:users,number_id','min:3'],
    ...
    public function messages()
    {
        return [
            ...
            'number_id.min' => 'El numero de identificacion debe tener al menos 3 caracteres',
            'number_id.max' => 'El numero de identificacion debe tener como máximo 50 caracteres',
