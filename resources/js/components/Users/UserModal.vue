					...
					<div class="modal-body">
						<section class="row">
							...
							<div class="col-12 d-flex justify-content-center mt-1">
								<img :src="image_preview" alt="Avatar Usuario" class="img-thumbnail " width="170"
									height="170">
							</div>
	...
	computed: {
		schema() {
			...
			if (!this.is_create) {
				...
				passwordValidation = yup.string().required('La contraseña es obligatoria').max(100, 'La contraseña no debe exceder los 100 caracteres');
				passwordConfirmation.oneOf([yup.ref('password'), null], 'Las contraseñas deben coincidir').required('Debe confirmar la contraseña').max(100, 'La confirmacion no debe exceder los 100 caracteres');
			}
			...
			return yup.object({
				...
				phone: yup.number('El telefono debe ser un numero').required('El telefono es requerido').typeError('El celular debe ser un número válido para colombia.'),
